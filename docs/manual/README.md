...
This manual is the **single source of truth for what trunk actually ships today** (workspace version `0.2.11`). If a behaviour is described here, it exists in the binary you can `cargo build` from `main`.
