...
This manual is the **single source of truth for what trunk actually ships today** (workspace version `0.4.1` — EPIC 1 Workbench MVP closed `v0.3.0` PR #208, EPIC 2 Agent autonomy closed `v0.4.0` PR #209, EPIC 3 Plugin platform ACTIVE with ISSUE 8 TASK 8.1 shipped via PR #211). If a behaviour is described here, it exists in the binary you can `cargo build` from `main`.
