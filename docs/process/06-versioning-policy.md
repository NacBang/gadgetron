...
- **Workspace version**: `0.4.0` (EPIC 1 + EPIC 2 모두 CLOSED — tag `v0.3.0` PR #208, tag `v0.4.0` PR #209)
- **활성 EPIC**: EPIC 1 (Workbench MVP) **CLOSED (v0.3.0)** + EPIC 2 (Agent autonomy) **CLOSED (v0.4.0)**. EPIC 1 shipped — ISSUE 1 (0.2.0), ISSUE 2 (0.2.1→0.2.4), ISSUE 2b (0.2.5), ISSUE 3 (0.2.6, PR #188), ISSUE 4 (0.2.7, PR #194); EPIC close = minor bump 0.2.12 → 0.3.0 + git tag `v0.3.0` (PR #208). EPIC 2 shipped — ISSUE 5 (0.2.8, PR #199), ISSUE 6 (0.2.9, PR #201), ISSUE 7 (first-class MCP server, 0.2.9 → 0.2.12, 3 PRs #204/#205/#207 — discovery + invoke + cross-session audit); EPIC close = minor bump 0.3.0 → 0.4.0 + git tag `v0.4.0` (PR #209).
