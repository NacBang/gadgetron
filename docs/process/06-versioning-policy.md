...
- **Workspace version**: `0.5.11` — full per-ISSUE / per-TASK shipping history lives in [`docs/ROADMAP.md`](../ROADMAP.md). Summary below.
- **활성 EPIC 목록**:
...
- **EPIC 4 progress** (patch-level bumps per ISSUE within 0.5.x):
  ...
  - **ISSUE 20** ⏳ TenantContext user_id plumbing — populate the ISSUE-19 `AuditEntry.actor_*` fields at the 7 call sites.
