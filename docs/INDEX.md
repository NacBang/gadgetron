...
| **운영자 Observability / 대시보드 (0.2.7+)** | [`manual/api-reference.md`](manual/api-reference.md) §GET /usage/summary + §GET /events/ws, [`manual/web.md`](manual/web.md) §`/web/dashboard` | [`manual/troubleshooting.md`](manual/troubleshooting.md) §`/events/ws` lag + 401 |
