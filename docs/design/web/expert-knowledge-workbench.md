...
Core lifecycle contract 자체는 `docs/design/core/knowledge-candidate-curation.md` 가 authoritative 하고, 본 문서는 그 contract 를 UI read model 과 interaction 으로 투영한다.
