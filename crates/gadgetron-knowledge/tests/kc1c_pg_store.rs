//! Integration test — `PgActivityCaptureStore` round-trip.
//!
//! # What this covers
//!
...
/// extension. We skip the Pg tests on the same condition the maintenance
/// and gadget Pg tests use — matching the existing pattern and avoiding
/// a false "infra failure" in the CI pre-flight gate.
///
