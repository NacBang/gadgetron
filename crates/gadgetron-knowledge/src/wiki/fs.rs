//! Path resolution for wiki pages. Enforces path-traversal protection.
//!
...
//! handles URL-level percent-decoding; that is a separate boundary.
...
mod tests {
    ...
    fn percent_encoded_dotdot_is_not_decoded_by_fs_but_stays_inside_root() {
        // URL-level decoding is the gadgetron-web boundary.
