...
//! and define them at the end (`[^1]: <page_path> ...`). This module
//! ships a minimal parser so downstream renderers (Web UI, CLI markdown
//! printer) have a shared definition of what counts as a "Penny
//! citation".
//!
//! # Scope
//!
//! This module is intentionally small — it parses the footnote
...
//!   forbidden; downstream filtering is future work.
//!
//! # Format
//!
...
[^2]: page/b";
    ...
    fn extract_citation_refs_ignores_code_fences() {
        // The parser is deliberately simple — no fence state machine.
