...
//!
//! `RuntimeMetaV1` will land a strict deny-unknown-fields deserializer
//! for the `external_runtime_meta` JSONB column path — that is a
//! different consumer and lives outside this module.
