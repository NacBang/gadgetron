...
//! write. The current build ships with this in-memory store because
//! Gadgetron is still single-instance; approvals lost on restart are
//! acceptable.
//!
//! A Postgres-backed store slots in behind the same trait when
//! Gadgetron grows to multi-instance.
...
impl ApprovalStore for InMemoryApprovalStore {
    ...
    async fn mark_approved(
        ...
        // Real user preferred; api_key_id fallback for legacy keys.
