...
- **EPIC 4 — Multi-tenant / XaaS** (ISSUEs 11/12/13/14, close-for-1.0 → `v1.0.0`, **ACTIVE** 2026-04-20): per-tenant quotas/rate-limits, integer-cent billing, HuggingFace catalog, tenant self-service. **ISSUE 11 complete** (TASK 11.1–11.4 shipped across 0.5.1–0.5.4 / PRs #230 / #231 / #232 / #234); **ISSUE 12 TASK 12.1 shipped** (PR #236 / 0.5.5 — `billing_events` ledger). ISSUEs 12 (billing) / 13 (HF catalog) / 14 (tenant self-service) are commercialization layer — **deferred / opportunistic per 2026-04-20 scope direction**, not gate-blockers for `v1.0.0` (post-1.0 patch / minor bumps).
